...
def preprocess_data(df, college_df, cities_df):
    ...
    # The dataset has 'Role' column.
    # We convert it to 'Role_Manager' (1 if Manager, 0 otherwise)
    ...
    # Note: Streamlit app asks for 'Previous CTC', 'Previous job change',
